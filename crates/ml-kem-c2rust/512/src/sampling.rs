...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_rej_uniform_x4(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_rej_uniform(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_cbd2(
    mut r: *mut mlk_poly,
    mut buf: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_cbd3(
    mut r: *mut mlk_poly,
    mut buf: *const uint8_t,
) {
    let mut i: ::core::ffi::c_uint = 0;
    ...
    while i < (MLKEM_N / 4 as ::core::ffi::c_int) as ::core::ffi::c_uint {
        ...
        let t: uint32_t = mlk_load24_littleendian(
            buf.offset((3 as ::core::ffi::c_uint).wrapping_mul(i) as isize),
        ) as uint32_t;
        let mut d: uint32_t = t & 0x249249 as uint32_t;
        d = d.wrapping_add(t >> 1 as ::core::ffi::c_int & 0x249249 as uint32_t);
        d = d.wrapping_add(t >> 2 as ::core::ffi::c_int & 0x249249 as uint32_t);
        j = 0 as ::core::ffi::c_uint;
        while j < 4 as ::core::ffi::c_uint {
            let a: int16_t = (d
                >> (6 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(0 as ::core::ffi::c_uint) & 0x7 as uint32_t)
                as int16_t;
            let b: int16_t = (d
                >> (6 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(3 as ::core::ffi::c_uint) & 0x7 as uint32_t)
                as int16_t;
            (*r)
                .0
                .coeffs[(4 as ::core::ffi::c_uint).wrapping_mul(i).wrapping_add(j)
                as usize] = (a as ::core::ffi::c_int - b as ::core::ffi::c_int)
                as int16_t;
            j = j.wrapping_add(1);
        }
