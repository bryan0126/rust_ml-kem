extern "C" {
    ...
    static mut PQCP_MLKEM_NATIVE_MLKEM512_C_ct_opt_blocker_u64: uint64_t;
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_keypair_derand(
        pk: *mut uint8_t,
        sk: *mut uint8_t,
        coins: *const uint8_t,
    ) -> ::core::ffi::c_int;
    fn PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_enc(
        c: *mut uint8_t,
        m: *const uint8_t,
        pk: *const uint8_t,
        coins: *const uint8_t,
    ) -> ::core::ffi::c_int;
    fn PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_dec(
        m: *mut uint8_t,
        c: *const uint8_t,
        sk: *const uint8_t,
    ) -> ::core::ffi::c_int;
...
unsafe extern "C" fn mlk_ct_get_optblocker_u64() -> uint64_t {
    return PQCP_MLKEM_NATIVE_MLKEM512_C_ct_opt_blocker_u64;
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_check_pk(
    ...
    let mut mlk_alloc_p_reencoded: [uint8_t; 768] = [0; 768];
    ...
    if p.is_null() || p_reencoded.is_null() {
        ...
        PQCP_MLKEM_NATIVE_MLKEM512_C_polyvec_frombytes(p, pk as *const uint8_t);
        PQCP_MLKEM_NATIVE_MLKEM512_C_polyvec_reduce(p);
        PQCP_MLKEM_NATIVE_MLKEM512_C_polyvec_tobytes(p_reencoded as *mut uint8_t, p);
    ...
    mlk_zeroize(
        ...
        ::core::mem::size_of::<[uint8_t; 768]>() as size_t,
    );
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_check_sk(
    ...
    if test.is_null() {
        ...
        OQS_SHA3_sha3_256(
            test,
            sk.offset((2 as ::core::ffi::c_int * 384 as ::core::ffi::c_int) as isize),
            (2 as ::core::ffi::c_int * 384 as ::core::ffi::c_int
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_keypair_derand(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
    mut coins: *const uint8_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0;
    ret = PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_keypair_derand(
        pk,
        sk as *mut uint8_t,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_keypair(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    ...
    ) != 0 as ::core::ffi::c_int
    {
        ...
        ret = PQCP_MLKEM_NATIVE_MLKEM512_C_keypair_derand(
            pk,
            sk,
            coins as *const uint8_t,
        );
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_enc_derand(
    mut ct: *mut uint8_t,
    mut ss: *mut uint8_t,
    mut pk: *const uint8_t,
    mut coins: *const uint8_t,
    ...
    if buf.is_null() || kr.is_null() {
        ...
        ret = PQCP_MLKEM_NATIVE_MLKEM512_C_check_pk(pk);
        if !(ret != 0 as ::core::ffi::c_int) {
            memcpy(
            ...
            ret = PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_enc(
                ct,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_enc(
    mut ct: *mut uint8_t,
    mut ss: *mut uint8_t,
    mut pk: *const uint8_t,
) -> ::core::ffi::c_int {
    ...
    } else if mlk_randombytes(coins, MLKEM_SYMBYTES as size_t) != 0 as ::core::ffi::c_int
    {
        ...
        ret = PQCP_MLKEM_NATIVE_MLKEM512_C_enc_derand(
            ct,
            ss,
            pk,
            coins as *const uint8_t,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_dec(
    mut ss: *mut uint8_t,
    ...
    let mut mlk_alloc_kr: [uint8_t; 64] = [0; 64];
    let mut kr: *mut uint8_t = &raw mut mlk_alloc_kr as *mut uint8_t;
    let mut mlk_alloc_tmp: [uint8_t; 800] = [0; 800];
    let mut tmp: *mut uint8_t = &raw mut mlk_alloc_tmp as *mut uint8_t;
    if buf.is_null() || kr.is_null() || tmp.is_null() {
        ret = MLK_ERR_OUT_OF_MEMORY;
    } else {
        ret = PQCP_MLKEM_NATIVE_MLKEM512_C_check_sk(sk);
        if !(ret != 0 as ::core::ffi::c_int) {
            ret = PQCP_MLKEM_NATIVE_MLKEM512_C_indcpa_dec(
                buf as *mut uint8_t,
                ct,
                sk as *const uint8_t,
            );
            if !(ret != 0 as ::core::ffi::c_int) {
                ...
                if !(ret != 0 as ::core::ffi::c_int) {
                    ...
                    OQS_SHA3_shake256(
                        ...
                        tmp,
                        (32 as ::core::ffi::c_int
                            + (2 as ::core::ffi::c_int * 320 as ::core::ffi::c_int
    ...
    mlk_zeroize(
        ...
        ::core::mem::size_of::<[uint8_t; 800]>() as size_t,
    );
