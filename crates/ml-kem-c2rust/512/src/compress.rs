...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_compress_d4(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_compress_d10(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_decompress_d4(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_decompress_d10(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_tobytes(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_frombytes(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_frommsg(
    mut r: *mut mlk_poly,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM512_C_poly_tomsg(
    mut msg: *mut uint8_t,
