...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_tomont(mut r: *mut mlk_poly) {
    mlk_poly_tomont_c(r);
}
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_reduce(mut r: *mut mlk_poly) {
    mlk_poly_reduce_c(r);
}
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_add(
    mut r: *mut mlk_poly,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_sub(
    mut r: *mut mlk_poly,
    mut b: *const mlk_poly,
) {
    let mut i: ::core::ffi::c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_mulcache_compute(
    mut x: *mut mlk_poly_mulcache,
    mut a: *const mlk_poly,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_ntt(mut r: *mut mlk_poly) {
    mlk_poly_ntt_c(r);
}
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_invntt_tomont(
    mut r: *mut mlk_poly,
) {
