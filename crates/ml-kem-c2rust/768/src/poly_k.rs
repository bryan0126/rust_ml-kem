extern "C" {
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_tomont(r: *mut mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_mulcache_compute(
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_ntt(r: *mut mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_invntt_tomont(r: *mut mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_compress_d10(
        r: *mut uint8_t,
        a: *const mlk_poly,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_decompress_d10(
        r: *mut mlk_poly,
        a: *const uint8_t,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_tobytes(r: *mut uint8_t, a: *const mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_frombytes(r: *mut mlk_poly, a: *const uint8_t);
    fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_cbd2(r: *mut mlk_poly, buf: *const uint8_t);
...
#[inline]
unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_compress_du(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
    PQCP_MLKEM_NATIVE_MLKEM768_C_poly_compress_d10(r, a);
}
#[inline]
unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_decompress_du(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
    PQCP_MLKEM_NATIVE_MLKEM768_C_poly_decompress_d10(r, a);
}
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_compress_du(
    mut r: *mut uint8_t,
    ...
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_compress_du(
            r
                .offset(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_decompress_du(
    ...
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_decompress_du(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_tobytes(
    mut r: *mut uint8_t,
    mut a: *const mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_tobytes(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_frombytes(
    mut r: *mut mlk_polyvec,
    mut a: *const uint8_t,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_frombytes(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_ntt(
    mut r: *mut mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_ntt(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
        );
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_invntt_tomont(
    mut r: *mut mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_invntt_tomont(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
        );
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_basemul_acc_montgomery_cached(
    mut r: *mut mlk_poly,
    mut a: *const mlk_polyvec,
    mut b: *const mlk_polyvec,
    mut b_cache: *const mlk_polyvec_mulcache,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_mulcache_compute(
    ...
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_mulcache_compute(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_reduce(
    mut r: *mut mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_reduce(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
        );
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_add(
    mut r: *mut mlk_polyvec,
    mut b: *const mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_add(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_polyvec_tomont(
    mut r: *mut mlk_polyvec,
) {
    let mut i: ::core::ffi::c_uint = 0;
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM768_C_poly_tomont(
            (&raw mut (*r).0.vec as *mut mlk_poly).offset(i as isize) as *mut mlk_poly,
        );
        i = i.wrapping_add(1);
    }
...
unsafe extern "C" fn mlk_poly_cbd_eta1(mut r: *mut mlk_poly, mut buf: *const uint8_t) {
    PQCP_MLKEM_NATIVE_MLKEM768_C_poly_cbd2(r, buf);
}
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_getnoise_eta1_4x(
    mut r0: *mut mlk_poly,
    mut r1: *mut mlk_poly,
    mut r2: *mut mlk_poly,
    mut r3: *mut mlk_poly,
