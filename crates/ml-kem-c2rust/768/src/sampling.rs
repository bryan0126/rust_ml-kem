...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_rej_uniform_x4(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_rej_uniform(
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM768_C_poly_cbd2(
    mut r: *mut mlk_poly,
    mut buf: *const uint8_t,
) {
