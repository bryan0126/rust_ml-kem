...
#[inline]
unsafe extern "C" fn mlk_scalar_compress_d5(mut u: int16_t) -> uint8_t {
    let mut d0: uint32_t = (u as uint32_t).wrapping_mul(1290176 as uint32_t);
    return (d0
        .wrapping_add((1 as ::core::ffi::c_uint as uint32_t) << 26 as ::core::ffi::c_int)
        >> 27 as ::core::ffi::c_int) as uint8_t;
}
#[inline]
unsafe extern "C" fn mlk_scalar_decompress_d5(mut u: uint8_t) -> int16_t {
    return ((u as uint32_t)
        .wrapping_mul(MLKEM_Q as uint32_t)
        .wrapping_add(16 as uint32_t) >> 5 as ::core::ffi::c_int) as int16_t;
}
#[inline]
unsafe extern "C" fn mlk_scalar_compress_d11(mut u: int16_t) -> uint16_t {
    let mut d0: uint64_t = (u as uint64_t).wrapping_mul(5284526080 as uint64_t);
    d0 = d0
        .wrapping_add((1 as ::core::ffi::c_uint as uint64_t) << 32 as ::core::ffi::c_int)
        >> 33 as ::core::ffi::c_int;
    return (d0 & 0x7ff as uint64_t) as uint16_t;
}
#[inline]
unsafe extern "C" fn mlk_scalar_decompress_d11(mut u: uint16_t) -> int16_t {
    return ((u as uint32_t)
        .wrapping_mul(MLKEM_Q as uint32_t)
        .wrapping_add(1024 as uint32_t) >> 11 as ::core::ffi::c_int) as int16_t;
}
unsafe extern "C" fn mlk_poly_compress_d5_c(
    mut r: *mut uint8_t,
    ...
    while i < (MLKEM_N / 8 as ::core::ffi::c_int) as ::core::ffi::c_uint {
        ...
        while j < 8 as ::core::ffi::c_uint {
            t[j as usize] = mlk_scalar_compress_d5(
                (*a)
                    .0
        ...
        *r.offset(i.wrapping_mul(5 as ::core::ffi::c_uint) as isize) = (0xff
            as ::core::ffi::c_int
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_d5(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
    mlk_poly_compress_d5_c(r, a);
}
unsafe extern "C" fn mlk_poly_compress_d11_c(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
    let mut j: ::core::ffi::c_uint = 0;
    j = 0 as ::core::ffi::c_uint;
    while j < (MLKEM_N / 8 as ::core::ffi::c_int) as ::core::ffi::c_uint {
        let mut k: ::core::ffi::c_uint = 0;
        let mut t: [uint16_t; 8] = [0; 8];
        k = 0 as ::core::ffi::c_uint;
        while k < 8 as ::core::ffi::c_uint {
            t[k as usize] = mlk_scalar_compress_d11(
                (*a)
                    .0
                    .coeffs[(8 as ::core::ffi::c_uint).wrapping_mul(j).wrapping_add(k)
                    as usize],
            );
            k = k.wrapping_add(1);
        }
        ...
        *r
            ...
            >> 8 as ::core::ffi::c_int
            | (t[1 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 3 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
        ...
        *r
            ...
            | (t[3 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 1 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(5 as ::core::ffi::c_uint) as isize,
            ) = (t[3 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 7 as ::core::ffi::c_int
            | (t[4 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
        ...
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(6 as ::core::ffi::c_uint) as isize,
            ) = (t[4 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 4 as ::core::ffi::c_int
            | (t[5 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 7 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(7 as ::core::ffi::c_uint) as isize,
            ) = (t[5 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 1 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(8 as ::core::ffi::c_uint) as isize,
            ) = (t[5 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 9 as ::core::ffi::c_int
            | (t[6 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 2 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(9 as ::core::ffi::c_uint) as isize,
            ) = (t[6 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 6 as ::core::ffi::c_int
            | (t[7 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 5 as ::core::ffi::c_int & 0xff as ::core::ffi::c_int) as uint8_t;
        *r
            .offset(
                (11 as ::core::ffi::c_uint)
                    .wrapping_mul(j)
                    .wrapping_add(10 as ::core::ffi::c_uint) as isize,
            ) = (t[7 as ::core::ffi::c_int as usize] as ::core::ffi::c_int
            >> 3 as ::core::ffi::c_int) as uint8_t;
        j = j.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_d11(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
    mlk_poly_compress_d11_c(r, a);
}
unsafe extern "C" fn mlk_poly_decompress_d5_c(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
    let mut i: ::core::ffi::c_uint = 0;
    ...
    while i < (MLKEM_N / 8 as ::core::ffi::c_int) as ::core::ffi::c_uint {
        ...
        let offset: ::core::ffi::c_uint = i.wrapping_mul(5 as ::core::ffi::c_uint);
        t[0 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & *a.offset(offset.wrapping_add(0 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 0 as ::core::ffi::c_int) as uint8_t;
        t[1 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & (*a.offset(offset.wrapping_add(0 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 5 as ::core::ffi::c_int
                | (*a.offset(offset.wrapping_add(1 as ::core::ffi::c_uint) as isize)
                    as ::core::ffi::c_int) << 3 as ::core::ffi::c_int)) as uint8_t;
        t[2 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & *a.offset(offset.wrapping_add(1 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 2 as ::core::ffi::c_int) as uint8_t;
        t[3 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & (*a.offset(offset.wrapping_add(1 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 7 as ::core::ffi::c_int
                | (*a.offset(offset.wrapping_add(2 as ::core::ffi::c_uint) as isize)
                    as ::core::ffi::c_int) << 1 as ::core::ffi::c_int)) as uint8_t;
        t[4 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & (*a.offset(offset.wrapping_add(2 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 4 as ::core::ffi::c_int
                | (*a.offset(offset.wrapping_add(3 as ::core::ffi::c_uint) as isize)
                    as ::core::ffi::c_int) << 4 as ::core::ffi::c_int)) as uint8_t;
        t[5 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & *a.offset(offset.wrapping_add(3 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 1 as ::core::ffi::c_int) as uint8_t;
        t[6 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & (*a.offset(offset.wrapping_add(3 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 6 as ::core::ffi::c_int
                | (*a.offset(offset.wrapping_add(4 as ::core::ffi::c_uint) as isize)
                    as ::core::ffi::c_int) << 2 as ::core::ffi::c_int)) as uint8_t;
        t[7 as ::core::ffi::c_int as usize] = (0x1f as ::core::ffi::c_int
            & *a.offset(offset.wrapping_add(4 as ::core::ffi::c_uint) as isize)
                as ::core::ffi::c_int >> 3 as ::core::ffi::c_int) as uint8_t;
        j = 0 as ::core::ffi::c_uint;
        while j < 8 as ::core::ffi::c_uint {
            (*r)
                .0
                .coeffs[(8 as ::core::ffi::c_uint).wrapping_mul(i).wrapping_add(j)
                as usize] = mlk_scalar_decompress_d5(t[j as usize]);
            j = j.wrapping_add(1);
        }
        i = i.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_d5(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
    mlk_poly_decompress_d5_c(r, a);
}
unsafe extern "C" fn mlk_poly_decompress_d11_c(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
    let mut j: ::core::ffi::c_uint = 0;
    ...
    while j < (MLKEM_N / 8 as ::core::ffi::c_int) as ::core::ffi::c_uint {
        ...
        let mut base: *const uint8_t = a
            .offset((11 as ::core::ffi::c_uint).wrapping_mul(j) as isize)
            as *const uint8_t;
        t[0 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
        ...
        t[1 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
        ...
        t[2 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(2 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                ...
                | (*base.offset(4 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 10 as ::core::ffi::c_int)) as uint16_t;
        t[3 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(4 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                >> 1 as ::core::ffi::c_int
                | (*base.offset(5 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 7 as ::core::ffi::c_int)) as uint16_t;
        t[4 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(5 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                >> 4 as ::core::ffi::c_int
                | (*base.offset(6 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 4 as ::core::ffi::c_int)) as uint16_t;
        t[5 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(6 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                >> 7 as ::core::ffi::c_int
                | (*base.offset(7 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 1 as ::core::ffi::c_int
                | (*base.offset(8 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 9 as ::core::ffi::c_int)) as uint16_t;
        t[6 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(8 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                >> 2 as ::core::ffi::c_int
                | (*base.offset(9 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 6 as ::core::ffi::c_int)) as uint16_t;
        t[7 as ::core::ffi::c_int as usize] = (0x7ff as ::core::ffi::c_int
            & (*base.offset(9 as ::core::ffi::c_int as isize) as ::core::ffi::c_int
                >> 5 as ::core::ffi::c_int
                | (*base.offset(10 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int) << 3 as ::core::ffi::c_int)) as uint16_t;
        k = 0 as ::core::ffi::c_uint;
        while k < 8 as ::core::ffi::c_uint {
            (*r)
                .0
                .coeffs[(8 as ::core::ffi::c_uint).wrapping_mul(j).wrapping_add(k)
                as usize] = mlk_scalar_decompress_d11(t[k as usize]);
            k = k.wrapping_add(1);
        }
        j = j.wrapping_add(1);
    }
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_d11(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_tobytes(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_frombytes(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_frommsg(
    mut r: *mut mlk_poly,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_tomsg(
    mut msg: *mut uint8_t,
