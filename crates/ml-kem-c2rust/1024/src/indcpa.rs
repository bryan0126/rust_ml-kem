extern "C" {
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_reduce(r: *mut mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_add(r: *mut mlk_poly, b: *const mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_sub(r: *mut mlk_poly, b: *const mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_invntt_tomont(r: *mut mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_d5(
        r: *mut uint8_t,
        a: *const mlk_poly,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_d5(
        r: *mut mlk_poly,
        a: *const uint8_t,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_frommsg(r: *mut mlk_poly, msg: *const uint8_t);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_tomsg(msg: *mut uint8_t, r: *const mlk_poly);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_compress_du(
        r: *mut uint8_t,
        a: *const mlk_polyvec,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_decompress_du(
        r: *mut mlk_polyvec,
        a: *const uint8_t,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_tobytes(
        r: *mut uint8_t,
        a: *const mlk_polyvec,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_frombytes(
        r: *mut mlk_polyvec,
        a: *const uint8_t,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_ntt(r: *mut mlk_polyvec);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_invntt_tomont(r: *mut mlk_polyvec);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_basemul_acc_montgomery_cached(
        r: *mut mlk_poly,
        a: *const mlk_polyvec,
        b: *const mlk_polyvec,
        b_cache: *const mlk_polyvec_mulcache,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_mulcache_compute(
        x: *mut mlk_polyvec_mulcache,
        a: *const mlk_polyvec,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_reduce(r: *mut mlk_polyvec);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_add(
        r: *mut mlk_polyvec,
        b: *const mlk_polyvec,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_tomont(r: *mut mlk_polyvec);
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta1_4x(
        r0: *mut mlk_poly,
        r1: *mut mlk_poly,
        r2: *mut mlk_poly,
        r3: *mut mlk_poly,
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta2(
        r: *mut mlk_poly,
        seed: *const uint8_t,
        nonce: uint8_t,
    );
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_rej_uniform_x4(
        vec0: *mut mlk_poly,
        vec1: *mut mlk_poly,
        vec2: *mut mlk_poly,
        vec3: *mut mlk_poly,
    ...
    fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_rej_uniform(
        entry: *mut mlk_poly,
        seed: *mut uint8_t,
    );
...
pub const NULL: *mut ::core::ffi::c_void = ::core::ptr::null_mut::<
    ::core::ffi::c_void,
>();
pub const MLKEM_K: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
...
pub const MLKEM_POLYCOMPRESSEDBYTES_D11: ::core::ffi::c_int = 352 as ::core::ffi::c_int;
pub const MLKEM_POLYCOMPRESSEDBYTES_DU: ::core::ffi::c_int = MLKEM_POLYCOMPRESSEDBYTES_D11;
...
#[inline]
unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_dv(
    mut r: *mut uint8_t,
    mut a: *const mlk_poly,
) {
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_d5(r, a);
}
#[inline]
unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_dv(
    mut r: *mut mlk_poly,
    mut a: *const uint8_t,
) {
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_d5(r, a);
}
unsafe extern "C" fn mlk_pack_pk(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_tobytes(r as *mut uint8_t, pk);
    memcpy(
...
unsafe extern "C" fn mlk_unpack_pk(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_frombytes(pk, packedpk as *const uint8_t);
    memcpy(
...
unsafe extern "C" fn mlk_pack_sk(mut r: *mut uint8_t, mut sk: *const mlk_polyvec) {
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_tobytes(r, sk);
}
unsafe extern "C" fn mlk_unpack_sk(
    mut sk: *mut mlk_polyvec,
    mut packedsk: *const uint8_t,
) {
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_frombytes(sk, packedsk);
}
unsafe extern "C" fn mlk_pack_ciphertext(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_compress_du(r as *mut uint8_t, b);
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_compress_dv(
...
unsafe extern "C" fn mlk_unpack_ciphertext(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_decompress_du(b, c as *const uint8_t);
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_decompress_dv(
        v,
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_gen_matrix(
            ...
            as ::core::ffi::c_uint
    {
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_rej_uniform_x4(
    ...
    while i < (MLKEM_K * MLKEM_K) as ::core::ffi::c_uint {
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_rej_uniform(
            (&raw mut (*(&raw mut (*a).0.vec as *mut mlk_polyvec)
                .offset(i.wrapping_div(MLKEM_K as ::core::ffi::c_uint) as isize))
                .0
                .vec as *mut mlk_poly)
...
unsafe extern "C" fn mlk_matvec_mul(
    ...
    i = 0 as ::core::ffi::c_uint;
    while i < MLKEM_K as ::core::ffi::c_uint {
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_basemul_acc_montgomery_cached(
...
unsafe extern "C" fn mlk_keypair_getnoise_eta1(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta1_4x(
        ...
        (&raw mut (*pv).0.vec as *mut mlk_poly).offset(2 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        (&raw mut (*pv).0.vec as *mut mlk_poly).offset(3 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        seed,
        0 as uint8_t,
        1 as uint8_t,
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta1_4x(
        ...
        (&raw mut (*e).0.vec as *mut mlk_poly).offset(2 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        (&raw mut (*e).0.vec as *mut mlk_poly).offset(3 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        seed,
        4 as uint8_t,
        5 as uint8_t,
...
unsafe extern "C" fn mlk_enc_getnoise_eta1_eta2(
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta1_4x(
        ...
        (&raw mut (*sp).0.vec as *mut mlk_poly).offset(2 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        (&raw mut (*sp).0.vec as *mut mlk_poly).offset(3 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        coins,
        0 as uint8_t,
        1 as uint8_t,
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta1_4x(
        ...
        (&raw mut (*ep).0.vec as *mut mlk_poly).offset(2 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        (&raw mut (*ep).0.vec as *mut mlk_poly).offset(3 as ::core::ffi::c_int as isize)
            as *mut mlk_poly,
        coins,
        4 as uint8_t,
        5 as uint8_t,
    ...
    PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_getnoise_eta2(epp, coins, 8 as uint8_t);
}
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_indcpa_keypair_derand(
    mut pk: *mut uint8_t,
    mut sk: *mut uint8_t,
    mut coins: *const uint8_t,
) -> ::core::ffi::c_int {
    ...
    let mut mlk_alloc_a: [mlk_polymat; 1] = [mlk_polymat(mlk_polymat_Inner {
        vec: [mlk_polyvec(mlk_polyvec_Inner {
            vec: [mlk_poly(mlk_poly_Inner { coeffs: [0; 256] }); 4],
        }); 4],
    }); 1];
        ...
        || e.is_null() || pkpv.is_null() || skpv.is_null() || skpv_cache.is_null()
    {
        ...
        *coins_with_domain_separator.offset(MLKEM_SYMBYTES as isize) = MLKEM_K
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_gen_matrix(
            a,
            publicseed as *const uint8_t,
            0 as ::core::ffi::c_int,
        );
        mlk_keypair_getnoise_eta1(skpv, e, noiseseed as *const uint8_t);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_ntt(skpv);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_ntt(e);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_mulcache_compute(skpv_cache, skpv);
        mlk_matvec_mul(pkpv, a, skpv, skpv_cache);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_tomont(pkpv);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_add(pkpv, e);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_reduce(pkpv);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_reduce(skpv);
        mlk_pack_sk(sk, skpv);
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_indcpa_enc(
    mut c: *mut uint8_t,
    mut m: *const uint8_t,
        ...
        || sp_cache.is_null()
    {
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_frommsg(k, m);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_gen_matrix(
            at,
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_ntt(sp);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_mulcache_compute(sp_cache, sp);
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_invntt_tomont(b);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_invntt_tomont(v);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_add(b, ep);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_add(v, epp);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_add(v, k);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_reduce(b);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_reduce(v);
...
#[no_mangle]
pub unsafe extern "C" fn PQCP_MLKEM_NATIVE_MLKEM1024_C_indcpa_dec(
    mut m: *mut uint8_t,
    mut c: *const uint8_t,
    ...
    if b.is_null() || skpv.is_null() || v.is_null() || sb.is_null() || b_cache.is_null()
    {
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_ntt(b);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_mulcache_compute(b_cache, b);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_polyvec_basemul_acc_montgomery_cached(
            sb,
            skpv,
            b,
        ...
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_invntt_tomont(sb);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_sub(v, sb);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_reduce(v);
        PQCP_MLKEM_NATIVE_MLKEM1024_C_poly_tomsg(m, v);
    }
    mlk_zeroize(
